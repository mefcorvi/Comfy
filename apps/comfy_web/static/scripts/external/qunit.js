/*
* Forked by mefcorvi
* [03/09/11] Added ability to ignore some tests
*/
...
Test.prototype = {
    ...
    ignore: function() {
        ...
        li.innerHTML = '<b>Ignored: </b>' + this.name;
    },
...
var QUnit = {
	...
	test: function(testName, expected, callback, async) {
        ...
        test.ignored = config.isCurrentTestIgnored;
...
// Ignorance
QUnit.test.ignored = function(testName, expected, callback, async) {
    config.isCurrentTestIgnored = true;
    QUnit.test(testName, expected, callback, async);
    config.isCurrentTestIgnored = false;
}

QUnit.asyncTest.ignored = function(testName, expected, callback) {
    config.isCurrentTestIgnored = true;
